...
class OrderItemViewModel {
  ...
  @Command
  public void completeOrder(@ContextParam(ContextType.TRIGGER_EVENT) Event event){
    OrderEntity order = OrderEntity.get(orderId)
  ...
  @Command
  public void cancelOrder(@ContextParam(ContextType.TRIGGER_EVENT) Event event){
    OrderEntity order = OrderEntity.get(orderId)
    OrderEntity.withTransaction {
      order.setIsProcessed(false)
